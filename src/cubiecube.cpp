...
void cornerMultiply(cubiecube_t* cubiecube, cubiecube_t* b)
{
  ...
  corner_t cPerm[8] = {static_cast<corner_t>(0)};
...
{
  int edge;
  edge_t ePerm[12] = {static_cast<edge_t>(0)};
...
short getFRtoBR(cubiecube_t* cubiecube)
{
  int a = 0, x = 0, j;
  int b = 0;
  edge_t edge4[4] = {static_cast<edge_t>(0)};
...
{
  int a = 0, x = 0, j, b = 0;
  corner_t corner6[6] = {static_cast<corner_t>(0)};
...
int getURtoDF(cubiecube_t* cubiecube)
{
  int a = 0, x = 0;
  int b = 0, j;
  edge_t edge6[6] = {static_cast<edge_t>(0)};
...
{
  int a = 0, b = 0, x = 0, j;
  edge_t edge3[3] = {static_cast<edge_t>(0)};
...
{
  corner_t perm[8] = {static_cast<corner_t>(0)};
  int b = 0, i, j;
  for (i = 0; i < 8; i++)
...
{
  edge_t perm[12] = {static_cast<edge_t>(0)};
  int b = 0, i, j;
  for (i = 0; i < 12; i++)
